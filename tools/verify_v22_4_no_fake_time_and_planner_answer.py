...
contract = Path('auxiliary_brain/parameters/agent_parameter_contract.py').read_text(encoding='utf-8')
...
primary = Path('ai_core/agent_delegation/primary_brain_client.py').read_text(encoding='utf-8')
