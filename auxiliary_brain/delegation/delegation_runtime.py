...
class AgentDelegationRuntime:
    ...
    async def _execute_task_with_selected(self, task_graph: dict[str, Any], selected: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        for index, participant in enumerate(execution_order):
            ...
            dependency_blockers = self._dependency_blockers_for_participant(participant, agent_results, dependency_plan)
    ...
    def _dependency_blockers_for_participant(self, participant: dict[str, Any], completed_results: list[Any], dependency_plan: dict[str, Any]) -> list[dict[str, Any]]:
        pid = self._participant_identity(participant)
