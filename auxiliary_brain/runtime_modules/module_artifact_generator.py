    ...
    async def generate_artifact(self, *, run_id: str, node_id: str, generation_request: dict[str, Any]) -> dict[str, Any]:
        ...
        prompt = {
            "system": (
                ...
                "Prefer Python standard library only. Do not add third-party dependencies when a standard-library alternative exists. "
                "For runtime-local observation, use stdlib datetime/timezone facilities only; avoid optional timezone packages such as pytz. "
                "If a third-party package is unavoidable, declare it in manifest.dependencies.python_packages and explain why in manifest.dependency_policy. "
