...
## v39 Human-Readable Interaction Runtime

- Runtime converts missing information metadata into frontend-ready interaction contracts.
- `fields` are generated from runtime workflow metadata instead of hardcoded business rules.
- Each field includes a human-readable label, question, placeholder, type, and optional description/examples.
