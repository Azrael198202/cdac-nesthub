...
class BrowserAutomationBlueprintBuilder:
    ...
    attendance words, booking words, or domain-specific actions.
        ...
        *,
        ...
        blueprint = {
            ...
            "notes": [
                ...
                "Any business-specific page/action/schedule semantics must be generated outside ai_core and passed in source_step/runtime_metadata.",
    ...
    def _default_safety_policy(self) -> dict[str, Any]:
        return {
            ...
            "can_click_without_confirmation": False,
            "can_submit_forms_without_confirmation": False,
    ...
    def _readme(self, blueprint: dict[str, Any]) -> str:
        return (
            ...
            "This file is generic. Domain-specific URL, schedule, and action semantics must be generated by runtime planning, not hardcoded in ai_core.\n"
        )
