...
class ExecutorRegistry:
    def __init__(self): self.executors={'llm_json':LLMJsonExecutor(),'tool_call':ToolCallExecutor(),'workflow_call':WorkflowCallExecutor(),'mcp_call':MCPCallExecutor(),'human_review':HumanReviewExecutor(),'python_plugin':PythonPluginExecutor(),'static_transform':StaticTransformExecutor()}
