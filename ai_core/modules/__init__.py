...
The implementation for ai_core/modules now lives in auxiliary_brain/runtime_modules.
This facade preserves existing imports while keeping ai_core focused on generic brain/runtime contracts.
"""
from auxiliary_brain.runtime_modules.__init__ import *  # noqa: F401,F403
