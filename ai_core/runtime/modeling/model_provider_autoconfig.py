        ...
        return {
            ...
            "providers": {
                ...
                "vllm": {
                    ...
                    "logical_model_id": "qwen3.5:2b",
                    "auto_start": True,
                    "auto_install": False,
                    "ready_timeout_seconds": 120,
                    "ready_poll_interval_seconds": 2,
                    "start_command": "python -m vllm.entrypoints.openai.api_server --host 127.0.0.1 --port 8001 --model Qwen/Qwen3.5-2B --served-model-name Qwen/Qwen3.5-2B",
                    "timeout_seconds": 90,
                    "max_prompt_tokens": 12000,
                    "response_format_json": True,
                    "provider_models": {
                        "qwen3.5:2b": "Qwen/Qwen3.5-2B",
                        "qwen3.5:4b-q4_k_m": "Qwen/Qwen3.5-4B-Q4_K_M",
