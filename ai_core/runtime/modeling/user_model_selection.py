...
class UserModelSelectionSnapshot:
    ...
    initial_model_id: str = "qwen3.5:2b"
    initial_provider: str = "ollama"
    selected_local_model_id: str = "qwen3.5:2b"
...
class UserModelSelectionStore:
    ...
    def available_models(self, family: str | None = None) -> list[dict[str, Any]]:
        ...
        if not result and family == "local":
            result = [{"model_id": "qwen3.5:2b", "label": "Qwen3.5 2B", "family": "local", "provider": "ollama", "cost_class": "local", "requires_secret": None}]
        ...
        return sorted(result, key=lambda x: (0 if x.get("model_id") in {"qwen3.5:2b", "gpt-4o-mini"} else 1, str(x.get("model_id"))))
    ...
    def _default_local_model(self) -> str:
        ...
        for preferred in ["qwen3.5:2b", "qwen3.5:4b-q4_k_m", "qwen3:4b", "qwen3:8b", "qwen2.5:7b", "qwen3:14b"]:
            if preferred in ids:
                return preferred
        return ids[0] if ids else "qwen3.5:2b"
