...
class KnowledgeService:
    ...
    def save_success_case(self, run_id: str, data: dict)->None:
        ...
        with (RUNTIME_KNOWLEDGE/'success_cases.jsonl').open('a',encoding='utf-8') as f: f.write(json.dumps({'run_id':run_id,'created_at':datetime.utcnow().isoformat(),'data':data},ensure_ascii=False)+'\n')
