...
FIXED_EXECUTION_OPTIONS: tuple[ExecutionOption, ...] = (
    ...
    ExecutionOption("use_uploaded_file", "uploaded_artifact", "uploaded_artifact_contract", False, False, "runtime", "Use a user-uploaded artifact as the execution method. Inspect the artifact, infer runtime parameters, request missing values through UI, then execute in sandbox."),
...
ACTION_ALIASES: dict[str, str] = {
    ...
    "uploaded_file": "use_uploaded_file",
    "uploaded_artifact": "use_uploaded_file",
    "external_file": "use_uploaded_file",
    "external_method": "use_uploaded_file",
    "use_file": "use_uploaded_file",
    "provided_file": "use_uploaded_file",
